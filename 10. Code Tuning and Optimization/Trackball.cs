    ...
    public class Trackball
    {
        ...
        public FrameworkElement EventSource
        {
            ...
            set
            {
                if (value != null)
                {
                    value.MouseDown -= this.OnMouseDown;
                    value.MouseUp -= this.OnMouseUp;
                    value.MouseMove -= this.OnMouseMove;
                }
        ...
        private void Zoom(Point currentPosition)
        {
            ...
            double objectScale = Math.Exp(deltaY / 100);    // e^(yDelta/100) is fairly arbitrary.

            this.scale.ScaleX *= objectScale;
            this.scale.ScaleY *= objectScale;
            this.scale.ScaleZ *= objectScale;
        }
    }
}
