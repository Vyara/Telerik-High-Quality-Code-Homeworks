namespace Exceptions_Homework
{
    ...
    public class ExceptionsHomeworkTests
    {
        public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
        {
            ...
            if (count < 0)
            {
                throw new ArgumentException("Length of subsequence must be a positive number.", "substring length");
            }

            if (startIndex + count > arr.Length)
            {
                throw new ArgumentOutOfRangeException("substring length", "The length of the subsequence is larger than expected.");
            }
        ...
        public static string ExtractEnding(string str, int count)
        {
            ...
            if (count > str.Length)
            {
                throw new ArgumentOutOfRangeException("substring length", "Count cannot be greater than the string length.");
            }
